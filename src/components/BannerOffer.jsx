...
const BannerOffer = () => {
  ...
  return (
    <div className="w-full bg-[#1F1F1F] text-white px-4 py-3 text-xs sm:text-sm md:text-base">
      <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-6 max-w-screen-xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            aria-label="Facebook"
          >
            <FaFacebookF className="hover:text-blue-500 transition" size={16} />
          </a>
          <a
          ...
          >
            <FaInstagram className="hover:text-pink-500 transition" size={16} />
          </a>
        </div>
      </div>
    </div>
