...
export const loginUser = async (credentials) => {
  try {
    ...
    if (response.data.message) {
      localStorage.setItem("userToken", "A2m9Ls@*&92bjadmIuhuq88mAj8mqdna--AosdamnASMDjajd-as9mALMJAL12nalmdl23@**dns");
      localStorage.setItem("userTokenssss", "sA2m9L@*&92bjadmIuhuq88mAj8mqdna--AosdamnASMDjajd-as9mALMJAL12nalmdl23@**dns");
      ...
      localStorage.setItem("encrypted-ad-Data", "8lKASndjq9A*&nlkQjAmL*&8malkmsN2ajKldJ0aKLAS8ndajk9AosdkNAL8mknsdAKld02nak");
      ...
      localStorage.setItem("userTokensss", "A2m9L@*&92bjadmIuhuq88mAj8mqdna--AosdamnASMDjajd-as9mALMJAL12nalmdl23@**dns");
      ...
      if (response.data.isAdmin && response.data.token) {
        const admin = localStorage.getItem("encrypted-ad-Data");
        const trueAdmin = localStorage.getItem("userTokensss");
        if (response.data.isAdmin === admin && response.data.token === trueAdmin) {
